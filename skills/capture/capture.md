...
Raw idea text typed by Ben in Claude chat.
...
Preserve the exact verbatim input. This becomes the Raw Idea field.
...
→ Surface it: "This looks similar to [existing idea title] 
  captured on [date]. Merge or keep separate?"
...
This is the skill's interpretation — Ben edits it freely.

**Implementation Ideas:**
Generate 2-3 concrete execution paths.
Specific enough to act on. Not commitments — possibilities.
...
Nothing else. No summary. No options. No follow-up questions.
The work is done. Ben moves on.
...
One new row in BenOS / 04 — Idea Inbox / Idea Bank.
...
≥90% of captured ideas appear in Idea Bank with correct
business unit and type without manual correction by Ben.
...
- Proceed if Craft MCP is unavailable
