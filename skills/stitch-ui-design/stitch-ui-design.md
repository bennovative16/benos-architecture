...
| Triggers | "Stitch", "Google Stitch", "UI prototype", "Stitch design" |
| Date Built | 2026-05-12 |

## Purpose

Expert guidance for crafting effective prompts in Google Stitch, the AI-powered UI design tool by Google Labs. Helps Ben generate high-quality UI designs for web and mobile applications across SIPP and Bennovative ventures.
...
- Screen or component type (dashboard, landing page, mobile app, form, etc.)
- User context or app name
- Key features and functional requirements
- Visual style preferences (colors, aesthetic, layout)
- Target platform (mobile, web, responsive)
- Optional: reference screenshots or sketches for image-to-UI workflows

## Outputs

- Structured, production-ready prompts for Google Stitch
- Multi-screen prompt breakdowns for app flows
- Iteration and annotation strategies
- Export guidance (HTML/CSS, Figma, code snippets)
- Design-to-code workflow recommendations

## BenOS Integrations

- **stitch-design-taste** — pair with this skill to apply Ben's personal design aesthetic and brand voice before generating Stitch prompts; stitch-design-taste provides the visual opinionation, this skill provides the prompt structure.

## Customization Notes

Taken as-is from Antigravity source. No structural changes made. Generic tool references preserved verbatim — the export workflows (Stitch → Figma → Code) align naturally with BenOS's Figma MCP and Claude Code stack.
